...
class SqsDockerLambda(Construct):
    ...
    def __init__(self, scope: Construct, id: str) -> None:
        ...
        docker_construct = DockerLambdaWithoutLayer(self, id)
        self.queue = sqs.Queue(self, queue_name, queue_name=queue_name)
        docker_construct.fn.add_event_source(event_source.SqsEventSource(self.queue))
        self.fn = docker_construct.fn
